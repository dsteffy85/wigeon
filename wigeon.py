...
def cmd_query(args):
    ...
    data = processor.query_data(
        report_id=args.report_id, third_party_name=args.third_party, limit=args.limit, offset=args.offset
    )
...
def cmd_export(args):
    ...
    success = processor.export_data(
        output_path=args.output, report_id=args.report_id, third_party_name=args.third_party, format=args.format
    )
...
Examples:
  ...
  python wigeon.py stats
    ...
    dashboard_parser.add_argument("--interactive", "-i", action="store_true", help="Start interactive mode")
    dashboard_parser.add_argument("--recent", type=int, metavar="N", help="Show N most recent reports")
    dashboard_parser.add_argument("--search", metavar="TERM", help="Search reports")
    dashboard_parser.add_argument("--days", type=int, metavar="N", help="Show reports from last N days")
