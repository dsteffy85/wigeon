...
class WigeonDatabase:
    ...
    def add_report_data(self, report_id, third_party_id, data_rows):
        ...
        rows = [(report_id, third_party_id, idx, json.dumps(row)) for idx, row in enumerate(data_rows, 1)]
    ...
    def query_report_data(self, report_id=None, third_party_name=None, limit=None, offset=0):
