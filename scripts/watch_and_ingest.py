...
class WigeonWatcher:
    ...
    def is_ceva_file(self, filename):
        ...
        keywords = ['ceva', 'block open order', 'block service level', 
                   'block inventory', 'block srl', 'nortam']
    ...
    def scan_existing_files(self):
        ...
        for filepath in self.watch_dir.iterdir():
            ...
            # Check if it's a CEVA file and recent
            if self.is_ceva_file(filepath.name):
